...
`,y=()=>a("article",{className:l.article,children:[e("h1",{className:l.title,children:"Collapse"}),e("p",{className:l.desc,children:"A simple, accessible foundation for building custom UIs that show and hide content, like togglable accordion panels."}),e("h2",{className:l.heading,children:"Example"}),e("h3",{className:l.caption,children:"Collapse"}),a("div",{className:l.content,children:[e(p,{}),e("div",{className:l.code,children:e(t,{code:d})})]}),e("h3",{className:l.caption,children:"Accordion Collapse"}),a("div",{className:l.content,children:[e(h,{}),e("div",{className:l.code,children:e(t,{code:u})})]}),e("h2",{className:l.heading,children:"Accessibility"}),e("h3",{className:l.caption,children:"Keyboard Interaction"}),a("div",{className:l.content,children:[e("p",{className:l.detail,children:"When the disclosure control has focus:"}),a("p",{className:l.detail,children:[e("b",{children:"Enter"}),": activates the disclosure control and toggles the visibility of the disclosure content."]}),a("p",{className:l.detail,children:[e("b",{children:"Space"}),": activates the disclosure control and toggles the visibility of the disclosure content."]}),e(r,{href:"https://www.w3.org/TR/wai-aria-practices/#disclosure",children:"WAI-ARIA Authoring Practices - 3.10 Disclosure (Show/Hide)"})]})]});var N=y;export{N as default};
