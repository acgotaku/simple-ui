import{R as N,a as e,d as _,s as n,c as k,e as C,j as o,r as i,F as c,B as l,f as S,L as f}from"./index.3c04a82b.js";import{u as D,a as g}from"./useFocusTrap.44f971f8.js";import{u as y}from"./useWindowEvent.b29ef82f.js";import{P as x}from"./index.caa05957.js";import{s as r,C as V}from"./view.module.f8e5862e.js";const d=({children:a,visible:s,onClose:u,position:b="left"})=>{const m=N.useRef(null),w=h=>{h.stopPropagation()},p=()=>typeof u=="function"&&u(!1);D(s),y("keydown",h=>{h.key===C.Escape&&s&&p()});const v=g(s);return e(x,{children:e(_,{nodeRef:m,in:s,unmountOnExit:!0,timeout:300,classNames:{enter:n["mask-enter"],enterActive:n["mask-enter-active"],exit:n["mask-exit"],exitActive:n["mask-exit-active"]},children:e("div",{className:n.mask,ref:m,onClick:p,children:e("div",{role:"dialog","aria-modal":"true",className:k(n.drawer,n[b]),ref:v,onClick:w,children:a})})})})},P="_inner_125aq_1",q="_header_125aq_5",L="_close_125aq_11",B="_closeIcon_125aq_1",R="_button_125aq_35",T="_left_125aq_39",I="_right_125aq_43",E="_top_125aq_47",j="_bottom_125aq_51";var t={inner:P,header:q,close:L,closeIcon:B,button:R,left:T,right:I,top:E,bottom:j};const F=()=>{const[a,s]=i.exports.useState(!1);return o(c,{children:[e(l,{className:t.button,onClick:()=>s(!0),children:"Open Drawer"}),e(d,{visible:a,onClose:s,children:e("div",{className:t.left,children:o("div",{className:t.inner,children:[e("div",{className:t.header,children:e("button",{onClick:()=>s(!1),className:t.close,children:e(S,{className:t.closeIcon})})}),e(f,{to:"/button",children:"Button View"}),e("p",{children:"Press escape to close the drawer."}),e(f,{href:"https://github.com/acgotaku/simple-ui",children:"Github"}),e("p",{children:"Trap focus inside drawer."})]})})})]})},O=`
