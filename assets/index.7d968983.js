import{l as k,a as e,m as B,n as M,x as t,j as a,p as y,i as g,L as S,r as f,F as b,B as i}from"./index.8767a52a.js";import{u as x,a as V}from"./useFocusTrap.cf0aad6a.js";import{u as w}from"./useWindowEvent.20791b48.js";import{s as l,C as u}from"./view.module.3d2049d7.js";const p=({children:c,visible:o,closable:N=!1,onClose:r,title:m})=>{const h=k.useRef(null),v=d=>{d.stopPropagation()},n=()=>typeof r=="function"&&r(!1);x(o),w("keydown",d=>{d.key===g.Escape&&o&&n()});const C=V(o);return e(B,{children:e(M,{nodeRef:h,in:o,unmountOnExit:!0,timeout:300,classNames:{enter:t["mask-enter"],enterActive:t["mask-enter-active"],exit:t["mask-exit"],exitActive:t["mask-exit-active"]},children:e("div",{className:t.mask,ref:h,onClick:()=>N&&n(),children:e("div",{role:"dialog","aria-modal":"true",className:t.modal,ref:C,onClick:v,children:a("div",{className:t.inner,children:[m&&a("div",{className:t.header,children:[e("p",{className:t.title,children:m}),e("button",{onClick:n,className:t.close,children:e(y,{className:t.closeIcon})})]}),e("div",{className:t.body,children:c})]})})})})})},T="_modal_c4m7a_1",_="_footer_c4m7a_6",A="_footerButton_c4m7a_1";var s={modal:T,footer:_,footerButton:A};const R=()=>{const[c,o]=f.exports.useState(!1);return a(b,{children:[e(i,{onClick:()=>o(!0),children:"Default Modal"}),a(p,{visible:c,title:"Modal Title",onClose:o,children:[e("div",{className:s.modal,children:"Modal Body Content"}),a("div",{className:s.footer,children:[e(i,{color:"standard",className:s.footerButton,onClick:()=>o(!1),children:"close"}),e(i,{color:"primary",className:s.footerButton,onClick:()=>o(!1),children:"confirm"})]})]})]})},I=`
