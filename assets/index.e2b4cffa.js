import{l as N,a as e,m as _,n as k,o as n,c as C,i as S,j as o,r as i,F as c,B as l,p as D,L as b}from"./index.8767a52a.js";import{u as g,a as y}from"./useFocusTrap.cf0aad6a.js";import{u as x}from"./useWindowEvent.20791b48.js";import{s as a,C as V}from"./view.module.3d2049d7.js";const d=({children:r,visible:s,onClose:u,position:w="left"})=>{const m=N.useRef(null),f=h=>{h.stopPropagation()},p=()=>typeof u=="function"&&u(!1);g(s),x("keydown",h=>{h.key===S.Escape&&s&&p()});const v=y(s);return e(_,{children:e(k,{nodeRef:m,in:s,unmountOnExit:!0,timeout:300,classNames:{enter:n["mask-enter"],enterActive:n["mask-enter-active"],exit:n["mask-exit"],exitActive:n["mask-exit-active"]},children:e("div",{className:n.mask,ref:m,onClick:p,children:e("div",{role:"dialog","aria-modal":"true",className:C(n.drawer,n[w]),ref:v,onClick:f,children:r})})})})},z="_inner_10brz_1",P="_header_10brz_5",L="_close_10brz_11",B="_closeIcon_10brz_1",R="_wrapper_10brz_35",T="_button_10brz_41",I="_left_10brz_45",E="_right_10brz_49",j="_top_10brz_53",F="_bottom_10brz_57";var t={inner:z,header:P,close:L,closeIcon:B,wrapper:R,button:T,left:I,right:E,top:j,bottom:F};const O=()=>{const[r,s]=i.exports.useState(!1);return o(c,{children:[e(l,{className:t.button,onClick:()=>s(!0),children:"Open Drawer"}),e(d,{visible:r,onClose:s,children:e("div",{className:t.left,children:o("div",{className:t.inner,children:[e("div",{className:t.header,children:e("button",{onClick:()=>s(!1),className:t.close,children:e(D,{className:t.closeIcon})})}),e(b,{to:"/button",children:"Button View"}),e("p",{children:"Press escape to close the drawer."}),e(b,{href:"https://github.com/acgotaku/simple-ui",children:"Github"}),e("p",{children:"Trap focus inside drawer."})]})})})]})},A=`
