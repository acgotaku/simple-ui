...
);`,T=()=>{const{TabPane:t}=l;return n(l,{className:s.tabs,children:[a(t,{label:"Documents",name:"doc",className:s.pane,children:a("span",{children:"This is document content."})}),a(t,{label:"Start",name:"start",className:s.pane,disabled:!0,children:a("span",{children:"Get start guide."})}),a(t,{label:"Help",name:"help",className:s.pane,children:a("span",{children:"Help documents."})})]})},u=`
const { TabPane } = Tabs;
return (
  <Tabs className={tabsStyles.tabs}>
    <TabPane label="Documents" name="doc" className={tabsStyles.pane}>
...
`,N=()=>(b("Tabs | Simple UI"),n("article",{className:e.article,children:[a("h1",{className:e.title,children:"Tabs"}),a("p",{className:e.desc,children:"Tabs organize content into multiple sections and allow users to navigate between them. The content under the set of tabs should be related and form a coherent unit."}),a("h2",{className:e.heading,children:"Example"}),a("h3",{className:e.caption,children:"Tabs"}),n("div",{className:e.content,children:[a(r,{}),a("div",{className:e.code,children:a(c,{code:m})})]}),a("h3",{className:e.caption,children:"Tabs with activeTab"}),n("div",{className:e.content,children:[a(h,{}),a("div",{className:e.code,children:a(c,{code:p})})]}),a("h3",{className:e.caption,children:"Tabs with disabled Tab"}),n("div",{className:e.content,children:[a(T,{}),a("div",{className:e.code,children:a(c,{code:u})})]}),a("h2",{className:e.heading,children:"Accessibility"}),a("h3",{className:e.caption,children:"Keyboard Interaction"}),n("div",{className:e.content,children:[a("p",{className:e.detail,children:"For the tab list:"}),n("p",{className:e.detail,children:[a("b",{children:"Tab"}),": When focus moves into the tab list, places focus on the active tab element."]}),a("p",{className:e.detail,children:"When the tab list contains the focus, moves focus to the next element in the page tab sequence outside the tablist, which is the tabpanel unless the first element containing meaningful content inside the tabpanel is focusable."}),a("p",{className:e.detail,children:"When focus is on a tab element in a horizontal tab list:"}),n("p",{className:e.detail,children:[a("b",{children:"Left Arrow"}),": moves focus to the previous tab. If focus is on the first tab, moves focus to the last tab. Optionally, activates the newly focused tab."]}),n("p",{className:e.detail,children:[a("b",{children:"Right Arrow"}),": Moves focus to the next tab. If focus is on the last tab element, moves focus to the first tab. Optionally, activates the newly focused tab."]}),a(i,{href:"https://www.w3.org/WAI/ARIA/apg/patterns/tabpanel/",children:"Tabs"})]})]}));var S=N;export{S as default};
