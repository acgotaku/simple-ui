...
`,_=()=>{const r=[{name:"name",label:"Name"},{name:"age",label:"Age"},{name:"address",label:"Address"}],a=Array.from(Array(108).keys()).map(n=>({name:`Jim Green ${n+1}`,age:36,address:`London No. ${n+1} Lake Park`}));return e(h,{columns:r,dataSource:a,pagination:{pageSize:5,currentPage:3}})},W=`
const columns = [
  {
    name: 'name',
    label: 'Name'
